...
/*
fetch('https://api.github.com/repos/alexScriptVersion/project-update-page/contents/data.json?ref=main')
    .then(res => res.json())
    .then(data => {
        console.log(data)
    })
...
fetch('https://raw.githubusercontent.com/alexScriptVersion/project-update-page/main/data.json')
    .then(res => res.json())
    .then(data => {
        console.log(data)
        jsonData = data
